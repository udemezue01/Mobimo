    ...
    <form class="mt-8" action="">
      ...
      <div class="rounded-md shadow-sm">
        ...
        Email*
          ...
          <input aria-label="Email address" name="email" type="email" required class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-400 placeholder-gray-500 text-gray-800 rounded-md shadow-md font-body font-bold tracking-wider focus:outline-none focus:shadow-outline-purple focus:border-purple-700 focus:z-10 sm:text-sm sm:leading-5" placeholder="" />
        </div>
        <div class="mt-6">
        	<label class="block text-gray-700 text-sm font-bold mb-2 font-body tracking-wider" for="password">
        Password*
      </label>
          <input aria-label="Password" name="password" type="password" required class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-400 placeholder-gray-500 text-gray-800 rounded-md shadow-md font-body tracking-wider font-bold focus:outline-none focus:shadow-outline-purple focus:border-purple-700 focus:z-10 sm:text-sm sm:leading-5" placeholder="" />
        </div>
      </div>

      <div class="mt-6 flex items-center justify-between">
        <div class="flex items-center">
          <input id="remember_me" type="checkbox" class="form-checkbox h-4 w-4 text-purple-600 transition duration-150 ease-in-out rounded-md" />
          <label for="remember_me" class="font-extrabold ml-2 block text-sm leading-5 text-gray-700 font-body">
            Remember me
          </label>
        </div>

        <div class="text-sm leading-5">
          <a href="#" class="font-extrabold text-purple-600 hover:text-purple-600 focus:outline-none focus:underline transition ease-in-out duration-150">
